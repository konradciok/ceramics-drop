...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: t('meta.collections.wazonySrednie'),
    alternates: alternatesFor(locale as Locale, '/wazony-srednie'),
  };
}
...
export default async function Page({ params }: Props) {
  ...
  return (
    <main>
      <JsonLd data={collectionSchema({ slug: 'wazony-srednie', locale: locale as Locale, t, soldIds })} />
      <CollectionScreen slug="wazony-srednie" />
    </main>
  );
}
